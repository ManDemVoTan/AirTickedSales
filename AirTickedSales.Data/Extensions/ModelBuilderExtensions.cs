    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AppConfig>().HasData(
                new AppConfig() { Key = "HomeTitle", Value = "This is home page of AirTickerSales" },
                new AppConfig() { Key = "HomeKeyWord", Value = "This is keyword page of AirTickerSales" },
                new AppConfig() { Key = "HomeDescription", Value = "This is desCripton page of AirTickerSales" });
